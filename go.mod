module github.com/ProovGroup/worker-claim-declaration

go 1.22.3

require (
	github.com/ProovGroup/lib-claim-models v1.4.8
...
require (
	...
	github.com/ProovGroup/lib-core-models-base v1.1.1 // indirect
